    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="text-center text-primary header2">Welcome to The Learning Hub Platform <sec:authentication
                ...
                <c:choose>
                    <c:when test="${popular.size()>= 1}">
                        <c:forEach var="i" begin="0" end="${popular.size()-1}">
                            <div class='item'>
                                <img src="${popular.get(i).getImageData()}"
                                     class='img-responsive'>
                                <h2>${popular.get(i).getTitle()}</h2>
                                <p>${popular.get(i).getDescription()}</p>
                                <a href='${pageContext.request.contextPath}/course/${popular.get(i).getIdcourse()}'>
